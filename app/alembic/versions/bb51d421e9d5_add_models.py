...
Revision ID: bb51d421e9d5
Revises: 
Create Date: 2026-04-10 16:13:52.011292
...
def upgrade() -> None:
    ...
    sa.Column('department', postgresql.ENUM('CABLE', 'TWIST', name='department', create_type=False), nullable=True),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
